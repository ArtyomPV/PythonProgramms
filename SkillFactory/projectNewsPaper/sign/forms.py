...
class RegisterForm(UserCreationForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            # 'password1': forms.PasswordInput(attrs={'class': 'form-control'}), # Для паролей виджет
            # не работает. Чтобы задать атрибуты, например, название класса, следует использовать поле
            # модели, как показано выше.
