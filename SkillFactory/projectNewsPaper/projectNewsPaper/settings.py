"""
Django settings for projectNewsPaper project.
...
SECRET_KEY = 'django-insecure-*j*)a7_+m##!%an1s8hczj!rk1k0f6$z3jk#y9cb68bbfsg7bo'
...
ROOT_URLCONF = 'projectNewsPaper.urls'
...
WSGI_APPLICATION = 'projectNewsPaper.wsgi.application'
